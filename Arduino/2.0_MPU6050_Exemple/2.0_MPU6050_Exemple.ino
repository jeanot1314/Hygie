...
void setup() {
  ...
  Serial.begin(38400);   //start serial to communicate process
  Wire.begin();
  delay(1);
  //check_MPU();
...
//  Serial.print(Euler[2], 3);
  //Serial.println();
//    int tmp[4];
//  tmp[0] = (unsigned char)Euler[0];
//  tmp[1] = (unsigned char)Euler[1];
//  tmp[2] = (unsigned char)Euler[2];
//  tmp[3] = (unsigned char)Euler[2];
//    Serial.print('A');
//    Serial.print(',');
//      Serial.print(tmp[0]);
//    Serial.print(",");
